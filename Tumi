...
\x1b[92;1m===================================>\x1b[92;1m
\x1b[93;1m Author       \x1b[92;1m=>      \x1b[93;1mPK 
\x1b[93;1m Whatsapp     \x1b[92;1m=>      \x1b[93;1m+8807******
\x1b[93;1m YouTube       \x1b[92;1m=>      \x1b[93;1mPK
\x1b[92;1m===================================>\x1b[92;1m
"""%(h))
...
def menu(): #Bilo
	...
	if farhan in ['1','01']:
		...
		os.system("xdg-open https://www.facebook.com/PK.LIFE.LOVE")
		exit()
	else:
		os.system("https://www.facebook.com/PK.LIFE.LOVE")
		exit()
...
def crack2(idf,pwv):
	...
	fff = '%'
	print('\r%s [PK] %s/%s  OK*%s | CP*%s => %s%s%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()
